...
output=$(${PT_sudo} /opt/splunk/bin/splunk http-event-collector create ${PT_hec_token_name} "${PT_hec_token_name}" -index default -uri "https://localhost:8089" -auth admin:simples1 2>&1)
